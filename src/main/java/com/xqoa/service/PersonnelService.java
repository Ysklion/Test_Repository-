...
public interface PersonnelService{
	 ...
	 * @return
	 */
    int updatePersonnel(Personnel value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyPersonnel(Personnel value, Assist assist);

    void insertPersonnelInput(PersonInput personInput);

	List<PersonOut> queryByAddr(String queryAddr, Integer queryAddrId);

	List<PersonOut> queryName(String queryName);
