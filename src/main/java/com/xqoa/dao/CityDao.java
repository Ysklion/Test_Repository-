...
public interface CityDao{
	 ...
	 * @return
	 */
    int updateCity(@Param("enti") City value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyCity(@Param("enti") City value, @Param("assist") Assist assist);
}