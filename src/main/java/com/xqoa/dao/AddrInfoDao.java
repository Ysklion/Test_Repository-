...
public interface AddrInfoDao{
	 ...
	 * @return
	 */
    int updateAddrInfo(@Param("enti") AddrInfo value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAddrInfo(@Param("enti") AddrInfo value, @Param("assist") Assist assist);
}