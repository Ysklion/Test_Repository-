...
public interface ProvinceDao{
	 ...
	 * @return
	 */
    int updateProvince(@Param("enti") Province value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyProvince(@Param("enti") Province value, @Param("assist") Assist assist);
}